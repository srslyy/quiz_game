"""Final version of Fully working program of Maori Numbers and Colours Quiz
Fixed Q3 answer and points issue
By Sarah Kan
11/05/2023
"""
...
class MainWindow:
    ...
    def next_q(self):
        ...
        if self.selected is True:
            ...
            self.box.set("Select Answer")
            self.a_menu.config(state="normal")  # Enables drop-down menu
            self.submit.config(state="normal")  # Enables submit again
...
Q_list = [(1, "Question 1 - What is the Maori word for green?", "KOWHAI",
          ...
          (2, "Question 2 - What is the Maori word for two?", "RIMA", "TORU",
           "RUA"),
          (3, "Question 3 - What number is ono?", "FOUR", "SIX", "SEVEN"),
